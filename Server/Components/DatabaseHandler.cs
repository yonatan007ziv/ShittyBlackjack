...
{
	private const string connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""D:\Code\VS Community\Blackjack\Server\Components\Sql\Database.mdf"";Integrated Security=True";
	private readonly static SqlConnection conn = new SqlConnection(connString);

	// Used to initialize the static fields
